...
def obtenerAngulos(results, width, height):
    for hand_landmarks in results.multi_hand_landmarks:
        ...
        num_den1 = (l1**2 + l3**2 - l2**2) / (2 * l1 * l3) if (l1*l3) != 0 else 0
        num_den2 = (l4**2 + l6**2 - l5**2) / (2 * l4 * l6) if (l4*l6) != 0 else 0
        num_den3 = (l7**2 + l9**2 - l8**2) / (2 * l7 * l9) if (l7*l9) != 0 else 0
        num_den4 = (l10**2 + l12**2 - l11**2) / (2 * l10 * l12) if (l10*l12) != 0 else 0
        num_den5 = (l13**2 + l15**2 - l14**2) / (2 * l13 * l15) if (l13*l15) != 0 else 0
        num_den6 = (l16**2 + l18**2 - l17**2) / (2 * l16 * l18) if (l16*l18) != 0 else 0

        angle1 = round(degrees(abs(acos(num_den1)))) if -1 < num_den1 < 1 else 0
        angle2 = round(degrees(abs(acos(num_den2)))) if -1 < num_den2 < 1 else 0
        angle3 = round(degrees(abs(acos(num_den3)))) if -1 < num_den3 < 1 else 0
        angle4 = round(degrees(abs(acos(num_den4)))) if -1 < num_den4 < 1 else 0
        angle5 = round(degrees(abs(acos(num_den5)))) if -1 < num_den5 < 1 else 0
        angle6 = round(degrees(abs(acos(num_den6)))) if -1 < num_den6 < 1 else 0
